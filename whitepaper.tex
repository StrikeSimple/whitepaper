...
\node[single arrow, draw, line width=0.8pt, minimum width=1.25cm, minimum height=1.5cm,
      single arrow head extend=1.5mm, color=wbred] (Centry) at (0,1.3) {\color{black} Cash};
...
\node[ell] (cashRes) at (3.3,-0.7) {Cash};
...
capped bear-put-spread residual plus the lower-strike put carried further down the ladder.
